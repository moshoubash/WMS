    ...
    public partial class AddTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Warehouses_ContactInfos_ContactInfoId",
                        column: x => x.ContactInfoId,
                        principalTable: "ContactInfos",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5aaae423-3d0a-4bb5-a7b4-8d1d43b48678", null, "WarehouseManager", "WarehouseManager" },
                    { "8f14f117-ebc5-4ac0-a597-dcd8ee316dcf", null, "WarehouseWorker", "WarehouseWorker" },
                    { "8fd124b9-e3f2-4803-94d2-34edfd39651b", null, "Admin", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_ContactInfoId",
                table: "Warehouses",
                column: "ContactInfoId",
                unique: true,
                filter: "[ContactInfoId] IS NOT NULL");
